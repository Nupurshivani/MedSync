      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-wrap justify-between space-x-4">
          ...
          <div className="space-y-4 w-full md:w-auto">
            ...
            <p className="text-sm leading-relaxed max-w-xs">
              The MedSync platform simplifies hospital management with
        ...
        <div className="mt-8 pt-8 border-t border-[#b6dbfc]/30 text-center">
          ...
          className={`${
            ...
            "The information provided on MedSync is intended for general
            ...
            treatment. MedSync facilitates OPD appointment booking and
